...
def main():
    ...
    a7_og_time_out = 0
    a7_og_steps = 0
    a7_og_prey_certain = 0
    a7_og_predator_certain = 0
    ...
    for i in range(num_environments):
        ...
        for j in range(num_runs):
            ...
            if result_3_og == 1:
                ...
                a3_og_time_out +=1
            a3_og_prey_certain += test_agent_3.certain_prey_pos
            ...
            if result_5_og == 1:
                ...
                a5_og_time_out +=1
            a5_og_predator_certain += test_agent_5.certain_predator_pos
            ...
            if result_7_og == 1:
                ...
                a7_og_time_out +=1
            a7_og_prey_certain += test_agent_7.certain_prey_pos
            a7_og_predator_certain += test_agent_7.certain_predator_pos
    ...
    print(f"Steps where certain of prey pos (and correct): {round(a3_og_prey_certain/a3_og_steps * 100, 3)}%")
    ...
    print(f"Steps where certain of predator pos (and correct): {round(a5_og_predator_certain/a5_og_steps * 100, 3)}%")
    ...
    print(f"Steps where certain of prey pos (and correct): {round(a7_og_prey_certain/a7_og_steps * 100, 3)}%")
    print(f"Steps where certain of predator pos (and correct): {round(a7_og_predator_certain/a7_og_steps * 100, 3)}%")
